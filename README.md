...
## Installation
1. Laden Sie die aktuelle Version des Moduls herunter (https://github.com/herrpfarrer/etliste/releases/latest/download/mod_etlistev1.0.zip). Sie brauchen die heruntergeladene Datei nicht zu entpacken.
...
7. Wählen Sie auf der rechten Seite des Reiters 'Modul' eine Position ein auf Ihrer Joomla-Seite ein, an der das Modul erscheinen soll, z.B. eine Sidebar. Beachten Sie dazu unbedingt auch Punkt 8! 
